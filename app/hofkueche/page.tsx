...
export default function HofkuechePage() {
  return (
    <main>
      ...
      <MenuTabs />
      <section className="kitchen-season wrap" aria-labelledby="kitchen-season-heading">
        <div><p className="eyebrow">Aus der Saison</p><h2 id="kitchen-season-heading">Auch der Sommer<br />kommt auf den Tisch.</h2><p>Wenn die Erdbeeren reif sind, werden sie zum Dessert, zum Kuchen und zum kleinen Glücksmoment zwischendurch.</p></div>
        <div className="kitchen-gallery"><div><Image src={assetPath("/images/erdbeer-schild.jpg")} alt="Erdbeeren aus der Region" fill sizes="(max-width: 700px) 50vw, 25vw" /></div><div><Image src={assetPath("/images/erdbeer-stillleben.jpg")} alt="Frische Erdbeere auf dem Hof" fill sizes="(max-width: 700px) 50vw, 25vw" /></div></div>
      </section>
